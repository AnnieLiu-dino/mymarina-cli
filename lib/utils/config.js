...
const DEFAULT_TEMPLATE_REGISTRY_URL =
  "https://raw.githubusercontent.com/mymarina/mymarina-template-registry/main/templates.json";
...
function getTemplateRegistryUrl(registryUrl) {
  return registryUrl || process.env.MYMARINA_TEMPLATE_REGISTRY_URL || DEFAULT_TEMPLATE_REGISTRY_URL;
}
